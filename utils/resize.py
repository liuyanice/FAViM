...
def process_isic2018(
        dim=(512, 512), save_dir=r'C:\highsocre\YanliuPoly\YanLiu-segment\isic2017test/'):
    image_dir_path = r'C:\highsocre\YanliuPoly\YanLiu-segment\ISIC-2017_Test_v2_Data/'
    mask_dir_path = r'C:\highsocre\YanliuPoly\YanLiu-segment\ISIC-2017_Test_v2_Part1_GroundTruth/'
...
if __name__ == '__main__':
    process_isic2018(
        dim=(512, 512),
        save_dir=r'C:\highsocre\YanliuPoly\YanLiu-segment\isic2017test/')
